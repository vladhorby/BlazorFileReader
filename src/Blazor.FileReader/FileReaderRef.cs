...
namespace Blazor.FileReader
{
    ...
    public interface IFileReference
    {
        ...
        /// </summary>
        /// <returns></returns>
				ValueTask<IBase64Stream> OpenReadBase64Async();
        ...
        /// </summary>
        /// <returns></returns>
				ValueTask<MemoryStream> CreateMemoryStreamAsync();

        /// <summary>
        /// Convenience method to read the file into memory and returns it as a MemoryStream, using the specified buffersize.
        /// </summary>
        /// <returns></returns>
				ValueTask<MemoryStream> CreateMemoryStreamAsync(int bufferSize);

        /// <summary>
        /// Reads the file metadata
        /// </summary>
        /// <returns></returns>
				ValueTask<IFileInfo> ReadFileInfoAsync();
    }
    ...
    internal class FileReference : IFileReference
    {
        ...
        public async ValueTask<MemoryStream> CreateMemoryStreamAsync() {
            return await InnerCreateMemoryStreamAsync((int)(await ReadFileInfoAsync()).Size);
        }
        public ValueTask<MemoryStream> CreateMemoryStreamAsync(int bufferSize)
        {
        ...
        public async ValueTask<IFileInfo> ReadFileInfoAsync()
        {
            if (fileInfo == null)
            {
        ...
        public async ValueTask<IBase64Stream> OpenReadBase64Async()
        {
            return await this.fileLoaderRef.FileReaderJsInterop.OpenBase64Stream(fileLoaderRef.ElementRef, index);
        }

        private async ValueTask<MemoryStream> InnerCreateMemoryStreamAsync(int bufferSize)
        {
